...
import {
    MdVerified, MdBook, MdPayments, MdHistory,
    MdWorkspacePremium, MdSecurity, MdDownload, MdErrorOutline,
    MdTimeline, MdBadge, MdSchool, MdCheckCircle
} from 'react-icons/md';
                    ...
                    <div className="lg:col-span-8 bg-surface rounded-card p-10 shadow-bento border border-outline-variant/30 flex flex-col justify-center items-center text-center relative overflow-hidden">
                        ...
                        {stats.overdueBooks > 0 || stats.totalFines > 0 ? (
                            <>
                                ...
                                <h4 className="font-headline text-4xl italic text-on-surface mb-2">Clearance Pending</h4>
                                <p className="text-lg text-on-surface-variant max-w-md mx-auto mb-8 opacity-70">
                                    You have outstanding dues or overdue materials. Please settle them to receive your digital no-dues badge.
                                </p>
                            </>
                        ) : (
                            <>
                                ...
                                <p className="text-lg text-on-surface-variant max-w-md mx-auto mb-8 opacity-70">
                                    All library accounts are settled. You are eligible for the digital no-dues certificate.
                                </p>
                            </>
                        )}
                        ...
                        <div className="w-full bg-background rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-6 border border-outline-variant/30">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div className="text-left">
                                    <p className="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest opacity-60">Fine Balance</p>
