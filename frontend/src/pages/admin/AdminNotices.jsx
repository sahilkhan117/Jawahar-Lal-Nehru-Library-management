...
<input className="w-full bg-[#F1F5F9] border-none rounded-lg px-4 py-3 text-on-background focus:ring-2 focus:ring-primary focus:bg-white transition-all font-body-md text-body-md" placeholder="e.g., Library Closure on Friday" type="text"/>
</div>
<div>
<label className="block font-label-md text-label-md text-on-surface mb-2">Category</label>
<select className="w-full bg-[#F1F5F9] border-none rounded-lg px-4 py-3 text-on-background focus:ring-2 focus:ring-primary focus:bg-white transition-all font-body-md text-body-md appearance-none">
...
<button className="p-2 hover:bg-surface-variant rounded text-on-surface-variant" title="Bold">
<MdFormatBold className="" />
</button>
<button className="p-2 hover:bg-surface-variant rounded text-on-surface-variant" title="Italic">
<MdFormatItalic className="" />
</button>
<button className="p-2 hover:bg-surface-variant rounded text-on-surface-variant" title="Underline">
<MdFormatUnderlined className="" />
</button>
<div className="w-px h-6 bg-outline-variant mx-1"></div>
<button className="p-2 hover:bg-surface-variant rounded text-on-surface-variant" title="Bullet List">
<MdFormatListBulleted className="" />
</button>
<button className="p-2 hover:bg-surface-variant rounded text-on-surface-variant" title="Numbered List">
<MdFormatListNumbered className="" />
</button>
<div className="w-px h-6 bg-outline-variant mx-1"></div>
<button className="p-2 hover:bg-surface-variant rounded text-on-surface-variant" title="Insert Link">
<MdLink className="" />
</button>
<button className="p-2 hover:bg-surface-variant rounded text-on-surface-variant" title="Attach Image">
<MdImage className="" />
</button>
</div>

<div className="min-h-[300px] p-4 bg-white focus-within:ring-2 focus-within:ring-primary focus-within:ring-inset transition-all outline-none" contenteditable="true">
...
<button className="px-6 py-2 rounded-lg font-label-md text-label-md bg-primary text-on-primary shadow-md hover:bg-primary/90 transition-colors flex items-center gap-2">
<MdSend className="" /> Publish
                            </button>
</div>
</div>
</div>
...
<MdSignalCellular4Bar className="text-[14px]" />
<MdWifi className="text-[14px]" />
<MdBatteryFull className="text-[14px]" />
</div>
</div>
...
<span className="bg-primary/10 text-primary px-2 py-0.5 rounded text-[10px] font-semibold uppercase tracking-wider">System Update</span>
<span className="text-[10px] text-on-surface-variant">Just now</span>
</div>
<h4 className="font-label-md text-label-md text-on-background">Library Closure on Friday</h4>
<p className="text-[12px] text-on-surface-variant line-clamp-3">Start typing your notice here... The text will appear formatted in this preview box to show exactly how students will see it on their mobile devices.</p>
</div>
